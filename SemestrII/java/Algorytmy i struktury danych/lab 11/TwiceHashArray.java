...
public class TwiceHashArray{
    String[] array;
    int arrSize;
    int itemsInArray;
    
    public TwiceHashArray(int size){
        arrSize = size;
    ...
    private int hashFunction(String x){
        int h1  = Integer.parseInt(x) % arrSize;
        int h2 = Integer.parseInt(x) % arrSize - 1;
        int i = Integer.parseInt(x);
        int index = (h1 + i * h2) %arrSize;
        return index;
    }
    
    private int stepDistance(String x){
        return (Integer.parseInt(x) % arrSize - 1) % arrSize;
    }
    
    public String get(String key){
        int indexHash = Integer.parseInt(key) % arrSize;
        int stepDistance = stepDistance(key);
